...
protected:
	...
	bool Init(ISourcePawnEngine *spg_pEngine, IGameConfig *gameconf);
private:
...
public:
	...
	static void Init(ISourcePawnEngine *spg_pEngine, IGameConfig *gameconf);
...
private:
	static ISourcePawnEngine *spg_pEngine;
