...
IGameConfigManager *g_pGameConfs = NULL;	/**< Game config manager */
#endif //SMEXT_ENABLE_DBMANAGER
...
#endif
#if defined SMEXT_ENABLE_GAMECONF
	SM_GET_IFACE(GAMECONFIG, g_pGameConfs);
#endif
#if defined SMEXT_ENABLE_MEMUTILS
...
IVEngineServer *g_pEngine = NULL;				/**< IVEngineServer pointer */
IServerGameDLL *g_pGameDll = NULL;				/**< IServerGameDLL pointer */
...
#if !defined METAMOD_PLAPI_VERSION
	GET_V_IFACE_ANY(serverFactory, g_pGameDll, IServerGameDLL, INTERFACEVERSION_SERVERGAMEDLL);
	GET_V_IFACE_CURRENT(g_pEngineFactory, g_pEngine, IVEngineServer, INTERFACEVERSION_VENGINESERVER);
#else
	GET_V_IFACE_ANY(GetServerFactory, g_pGameDll, IServerGameDLL, INTERFACEVERSION_SERVERGAMEDLL);
